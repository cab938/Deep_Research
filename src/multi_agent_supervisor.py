...
max_researcher_iterations = int(os.getenv("DEEP_RESEARCH_MAX_ITERATIONS", "15"))  # Calls to think_tool + ConductResearch + refine_draft_report

# Maximum number of concurrent research agents the supervisor can launch
# This is passed to the lead_researcher_prompt to limit parallel research tasks
max_concurrent_researchers = int(os.getenv("DEEP_RESEARCH_MAX_CONCURRENCY", "3"))
